...
public class MapPlace extends Fragment implements OnMapReadyCallback,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Initialize view
        mapView=inflater.inflate( R.layout.activity_map_place, container, false);
...
//        mapView = supportMapFragment.getView();
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.addMarker( new MarkerOptions().position( Hanoi ).title( "Bảo tàng Hà Nội" ).snippet( "Thủ đô của Việt Nam" ) );
